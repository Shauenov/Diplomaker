...
Find which template subjects are not in source file
"""
...
print()
print(f"Total missing from source: {len(missing_in_source)}")
print()
print("These are the 13 subjects that need to be added to source file or")
print("template needs to be adjusted.")
